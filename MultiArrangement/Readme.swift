...
////  MultiArrangement
////
////  Created by Budding Minds Admin on 2019-02-18.
////  Copyright © 2019 Budding Minds Admin. All rights reserved.
////
//
//// Documentation for Multi-Arrangement Project
//
////Organization:
////Matlab.swift -------------> translations of built-in MATLAB functions
////LiftTheWeakest.swift -----> same as ""
//
//import UIKit
//
//var testSet = [[[Double]]]()
...
////    }
//
//    // artificial input to currentPos here
...
//
//    if (minEvidenceWeight < minRequiredEvidenceWeight && (any(mat: argument, val: 0.0)) || etime(start: start) < maxSessionLength && trialI < 10) {
//        // remove all labels
////            for label in view.subviews{
////                if label.accessibilityIdentifier != nil {
...
//        maxI = maxIs[ceil(num: randNums[randI]*Double(nPairs))]
//        randI += 1
//    } else {
//        initialPairI = ceil(num: randNums[randI]*Double(nPairs))
//        randI += 1
//    }
//
...
//        //            print("line 358")
//        //            print(maxIs)
//        var maxI = maxIs[Int(ceil(randNums[randI]*Double(maxIs.count-1)))]   // no -1 in original
//        randI += 1
//        //                print("maxIs 277")
//        //                print(maxIs)
//        //                print("maxIs 279")
...
//    nPairs = (nItems^2 - nItems)/2   // pairs = n(n-1)/2
//
